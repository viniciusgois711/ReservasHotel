...
public class ReservaDB {
    ...
    public void inserirReserva(Reserva reserva){
        ...
        try(Connection conexao = getConnection();
            ...
            // alteração na tabela de quartos para mudar o status para ocupado
            try(PreparedStatement statement2 = conexao.prepareStatement("update quartos set ocupado = 'ocupado' where id = ?")){
                statement2.setInt(1, reserva.getId_quarto());
